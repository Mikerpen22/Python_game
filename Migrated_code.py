...
class NumberGame(Tk):
    def __init__(self):
        ...
        container.master.title('Treasure Hunter')

        self.frames = {}

        for F in (StartPage, Intro1, Game2IntroWindow, Intro3, MainWin1, Game2MainWindow, MainWin3, EndPage):
...
class StartPage(Frame):
    def __init__(self, parent, controller):
        ...
        self.image2 = self.image2.resize((160, 400), Image.ANTIALIAS)
        ...
        self.bg2 = Button(self, width=170, height=400, image=self.bg2_load, command=lambda: controller.show_frame(Game2IntroWindow))
...
class Intro1(Frame):
    ...
    def createWidgets(self):
        ...
        btn1 = Button(self, text="遊戲開始", height=1, width=8, command=lambda: self.controller.show_frame(MainWin1),
                      font=('微軟正黑體', 24))
        ...
        label6.grid(row=6, column=3, columnspan=6)
...
class MainWin1(Frame):
    ...
    def createWidgets(self):
        ...
        lbResult = Label(self, height=1, width=15, textvariable=result_str, font=('微軟正黑體', 18))
        ...
        lbNum.grid(row=2, column=3, columnspan=7)
...
class Game2IntroWindow(Frame):
    ...
    def createWidgets(self):
        label1 = Label(self, text="歡迎來到終極密碼遊戲", font=('微軟正黑體', 30))
        label2 = Label(self, text="規則說明:", font=('微軟正黑體', 24))
        ...
        label6 = Label(self, text="在五次機會中猜中一次即算成功，", font=('微軟正黑體', 18))
        btn1 = Button(self, text="遊戲開始", height=1, width=8, command=lambda: self.controller.show_frame(Game2MainWindow), font=('微軟正黑體', 24))
...
class Intro3(Frame):
    ...
    def createWidgets(self):
        ...
        label1 = Label(self, text="歡迎來到1A2B遊戲", font=('微軟正黑體', 30))
        label2 = Label(self, text="規則說明:", font=('微軟正黑體', 24))
